...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  final: { label: 'Final', className: 'bg-indigo-50 text-indigo-700 border-indigo-200' },
  ...
  // Lieferscheinstatus
  erstellt_ls: { label: 'Erstellt', className: 'bg-blue-50 text-blue-700 border-blue-200' },
  geliefert: { label: 'Geliefert', className: 'bg-emerald-50 text-emerald-700 border-emerald-200' },
}
